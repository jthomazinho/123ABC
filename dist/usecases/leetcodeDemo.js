...
exports.demonstrateLeetCodeExamples = demonstrateLeetCodeExamples;
const leetcodeExamples_1 = require("./leetcodeExamples");
function demonstrateLeetCodeExamples() {
    ...
    const parentheses = "()[]{}";
    const isValid = leetcodeExamples_1.LeetCodeExamples.isValidParentheses(parentheses);
    ...
    const maxSum = leetcodeExamples_1.LeetCodeExamples.maxSubArray(subarrayNums);
    ...
    const searchIndex = leetcodeExamples_1.LeetCodeExamples.binarySearch(sortedNums, searchTarget);
    ...
    const maxLength = leetcodeExamples_1.LeetCodeExamples.lengthOfLongestSubstring(substring);
    console.log(`   Input: "${substring}"`);
    console.log(`   Output: ${maxLength}\n`);
    // Example 6: Climbing Stairs
    console.log('6. Climbing Stairs Example:');
    const stairs = 5;
    const ways = leetcodeExamples_1.LeetCodeExamples.climbStairs(stairs);
    console.log(`   Input: n = ${stairs}`);
    console.log(`   Output: ${ways}\n`);
    // Example 7: Merge Sort
    console.log('7. Merge Sort Example:');
    const unsortedArray = [64, 34, 25, 12, 22, 11, 90];
    const sortedArray = leetcodeExamples_1.LeetCodeExamples.mergeSort([...unsortedArray]);
    ...
    const grouped = leetcodeExamples_1.LeetCodeExamples.groupAnagrams(anagrams);
    ...
    const fibNumber = 8;
    const fibResult = leetcodeExamples_1.LeetCodeExamples.fib(fibNumber);
