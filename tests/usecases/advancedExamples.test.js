...
const advancedExamples_1 = require("../../src/usecases/advancedExamples");
(0, globals_1.describe)('Advanced Examples Tests', () => {
    (0, globals_1.beforeEach)(() => {
        globals_1.jest.clearAllMocks();
    });
    (0, globals_1.it)('should connect to database when runAdvancedExamples is called', () => __awaiter(void 0, void 0, void 0, function* () {
        const { connectToDatabase } = yield Promise.resolve().then(() => __importStar(require('../../src/config/database')));
        yield (0, advancedExamples_1.runAdvancedExamples)();
    ...
    (0, globals_1.it)('should handle errors during execution', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, advancedExamples_1.runAdvancedExamples)();
        (0, globals_1.expect)(consoleErrorSpy).toHaveBeenCalledWith('❌ Error during advanced examples:', globals_1.expect.any(Error));
        consoleErrorSpy.mockRestore();
    }));
    (0, globals_1.it)('should complete execution without throwing errors', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, globals_1.expect)((0, advancedExamples_1.runAdvancedExamples)()).resolves.not.toThrow();
    }));
});
